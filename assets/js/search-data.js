...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "A PDF version of my resume is available on the right.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-fontan-project",
          title: 'Fontan project',
